...
namespace dptk {
std::string manpage
  = R"V0G0N(FROMMATRIX(1)             Dispersion Toolkit Manuals             FROMMATRIX(1)

NAME
       frommatrix - transform a point set sequence from UTK framework

SYNOPSIS
       frommatrix [--i FILE] [--o FILE] [--delimiter=CHARACTER] [--silent]
...
1.0.0                          December 1, 2020                  FROMMATRIX(1)
)V0G0N";
}
