...
/* generated by ./script/configure-file.py using template src/adapter/utk/manpage.hpp.in with data src/adapter/utk/manpage.1.pre. Manual edits will be OVERWRITTEN UNCONDITIONALLY. */

namespace dptk
{
 std::string manpage = R"V0G0N(UTKADAPTER(1)             Dispersion Toolkit Manuals             UTKADAPTER(1)
