 ...
 * src/measure/dispdumitrescu2017/manpage.hpp.in with data
 * src/measure/dispdumitrescu2017/manpage.1.pre. Manual edits will be OVERWRITTEN
 * UNCONDITIONALLY. */
...
DESCRIPTION
       Computes  dispersion,  n * dispersion, and/or the number of RRs consid‐
       ered of a given point set with cardinality n, almost according  to  Du‐
       mitrescu and Jiang, 2017 (https://doi.org/10.1007%2Fs00454-017-9871-1).
       ...
       of Dumitrescu and Jiang, the implementation uses the simpler while com‐
       putationally more expensive algorithm published by Naamad et.  al. 1984
       ().
...
OPTIONS
       ...
       --count-boxes
              Counts all empty boxes of P_i, considered as RRs in the publica‐
              tion.
...
1.2.0                          December 9, 2020         DISP-DUMITRESCU2017(1)
)V0G0N";
}
