...
/* generated by ./script/configure-file.py using template src/measure/pdisppermute/manpage.hpp.in with data src/measure/pdisppermute/manpage.1.pre. Manual edits will be OVERWRITTEN UNCONDITIONALLY. */

namespace dptk
{
 std::string manpage = R"V0G0N(DISP-PERMUTE(1)           Dispersion Toolkit Manuals           DISP-PERMUTE(1)

NAME
       disp-permute  -  compute p-dispersion with a permutation algorithm (ex‐
       haustive search)

SYNOPSIS
       disp-permute [--i FILE] [--o FILE] [--p=2] [--disp] [--ndisp] [--count-
...
OPTIONS
       ...
       --p=INTEGER
              The size of combinations out of n points of P_i, s.t.  the  num‐
              ber  of combinations are p out of n equalling the binomial coef‐
              ficient.  Boundary condition: p > 1.

       --disp Computes p-dispersion of P_i.

       --ndisp
              Computes p-dispersion of P_i, multiplied by the cardinality n of
              P_i.
