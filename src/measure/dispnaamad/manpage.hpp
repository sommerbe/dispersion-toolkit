 ...
 * src/measure/dispnaamad/manpage.hpp.in with data src/measure/dispnaamad/manpage.1.pre.
...
DESCRIPTION
       Computes dispersion, n * dispersion, and/or the number of RRs considered of a given point set with cardinali‐
       ty n, according to Naamad et.  al. 1984 (...URL...)
...
1.0.0                                             December 9, 2020                                     DISPNAAMAD(1)
)V0G0N";
}
