...
/* generated by ./script/configure-file.py using template src/measure/dispnaamad/manpage.hpp.in with data src/measure/dispnaamad/manpage.1.pre. Manual edits will be OVERWRITTEN UNCONDITIONALLY. */

namespace dptk
{
 std::string manpage = R"V0G0N(DISPNAAMAD(1)             Dispersion Toolkit Manuals             DISPNAAMAD(1)
...
DESCRIPTION
       Computes dispersion, n * dispersion, and/or the  number  of  restricted
       rectangles  (RRs)  considered  of a given point set with cardinality n,
       according          to          Naamad           et.            al. 1984
       (https://doi.org/10.1016/0166-218X(84)90124-0)
...
OPTIONS
       ...
       --count-boxes
              Counts  all  empty RRs of P_i, considered as RRs in the publica‐
              tion.
