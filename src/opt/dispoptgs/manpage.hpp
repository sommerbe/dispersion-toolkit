...
/* generated by ./script/configure-file.py using template src/opt/dispoptgs/manpage.hpp.in with data src/opt/dispoptgs/manpage.1.pre. Manual edits will be OVERWRITTEN UNCONDITIONALLY. */

namespace dptk
{
 std::string manpage = R"V0G0N(DISPOPTGS(1)              Dispersion Toolkit Manuals              DISPOPTGS(1)
