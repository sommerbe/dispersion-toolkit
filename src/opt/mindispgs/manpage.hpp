...
/* generated by ./script/configure-file.py using template src/opt/mindispgs/manpage.hpp.in
 * with data src/opt/mindispgs/manpage.1.pre. Manual edits will be OVERWRITTEN
 * UNCONDITIONALLY. */
