...
/* generated by ./script/configure-file.py using template src/stat/confidence/manpage.hpp.in with data src/stat/confidence/manpage.1.pre. Manual edits will be OVERWRITTEN UNCONDITIONALLY. */

namespace dptk
{
 std::string manpage = R"V0G0N(CONFIDENCE(1)             Dispersion Toolkit Manuals             CONFIDENCE(1)
