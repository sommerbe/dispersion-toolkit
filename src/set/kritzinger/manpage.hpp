...
/* generated by ./script/configure-file.py using template src/set/kritzinger/manpage.hpp.in with data src/set/kritzinger/manpage.1.pre. Manual edits will be OVERWRITTEN UNCONDITIONALLY. */

namespace dptk
{
 std::string manpage = R"V0G0N(KRITZINGERLATTICE(1)      Dispersion Toolkit Manuals      KRITZINGERLATTICE(1)
