...
/* generated by ./script/configure-file.py using template src/set/cswap/manpage.hpp.in with data src/set/cswap/manpage.1.pre. Manual edits will be OVERWRITTEN UNCONDITIONALLY. */

namespace dptk
{
 std::string manpage = R"V0G0N(CSWAP(1)                  Dispersion Toolkit Manuals                  CSWAP(1)
