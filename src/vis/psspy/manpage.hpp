...
/* generated by ./script/configure-file.py using template src/vis/psspy/manpage.hpp.in with data src/vis/psspy/manpage.1.pre. Manual edits will be OVERWRITTEN UNCONDITIONALLY. */

namespace dptk
{
 std::string manpage = R"V0G0N(PSS.PY(1)                 Dispersion Toolkit Manuals                 PSS.PY(1)
